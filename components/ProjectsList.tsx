            ...
            <div className="flex flex-col sm:flex-col gap-2 h-full">
              ...
              {p.links && p.links.length > 0 && (
                <ul className="flex flex-wrap gap-3 mt-2">
                  {p.links.map((link, k) => {
                    const isLive = link.label.toLowerCase().includes("live") || link.label.toLowerCase().includes("docs");
                      ...
                      <li key={k} className="truncate">
                        ...
                        >
                          {isLive ? (
                            ...
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
